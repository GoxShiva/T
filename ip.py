#!..𝙊𝙥𝙚𝙣 𝙎𝙤𝙪𝙧𝙘𝙚 𝘼𝙪𝙩𝙝𝙤𝙧: RUDRA 
#!..𝙊𝙬𝙣𝙚𝙧 𝙤𝙛 RUDRA 𝙖𝙣𝙙 RUDRA 𝙏𝙤𝙤𝙡𝙨
#!/usr/bin/env python3
import os
import sys
import re
...
{W}─────────────────────────────────────────────{W}
{W}[{G}•{W}]{G} DEVOLPER {W}:{G} ss \033[91m15 August 🇮🇳 🇮🇳\033[0m
    ...
    for i in range(num):
        try:
            ...
            headers = {
                ...
                "Accept-Language": "bn-BB,bn;q=0.9"
            }
